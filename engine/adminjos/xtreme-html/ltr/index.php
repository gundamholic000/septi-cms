...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin5" data-sidebartype="full" data-sidebar-position="absolute" data-header-position="absolute" data-boxed-layout="full">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="../../../login/logout.php"><i class="ti-logout m-r-5 m-l-5"></i> Log Out</a>
                            </div>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                            ...
                            <div class="user-profile d-flex no-block dropdown m-t-20">
                                ...
                                <div class="user-content hide-menu m-l-10">
                                    <a href="javascript:void(0)" class="" id="Userdd" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <h5 class="m-b-0 user-name font-medium"><?php echo $_COOKIE['USER'];?><i class="fa fa-angle-down"></i></h5>
                                        <span class="op-5 user-email"><?php echo $_COOKIE['EMAIL']?></span>
                                    </a>
                        ...
                        <li class="p-15 m-t-10"><a href="javascript:void(0)" class="btn btn-block create-btn text-white no-block d-flex align-items-center"><i class="fa fa-plus-square"></i> <span class="hide-menu m-l-5">Setting Alamat Toko</span> </a></li>
                        <!-- User Profile-->
        ...
        <div class="page-wrapper">
            ...
            <a href="alamat-baru.php">Tambah Alamat Baru</a>
                <!-- ============================================================== -->
                <!-- Sales chart -->
                <!-- ============================================================== -->
                <!-- <div class="row">
...
<?php
    ...
    echo "<script>alert('maaf anda tidak berhak mengakses halaman ini.. Terima kasih');</script>";
